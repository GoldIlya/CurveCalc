...
public class PointAdapter extends RecyclerView.Adapter<PointAdapter.PointViewHolder> {
    ...
    public PointAdapter(Context mCtx, SimpleXYSeries dataSet, SimpleXYSeries diffSet, OnItemClickListener onItemClickListener, Map<Integer, Integer> pointShiftMap) {
        this.mCtx = mCtx;
